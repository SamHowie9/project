...
for run in [1]:
    ...
    class VAE(keras.Model):
        ...
        def train_step(self, data):
            ...
            with tf.GradientTape() as tape:
                ...
                # total loss
                # total_loss = reconstruction_loss + kl_loss
                total_loss = reconstruction_loss + (0.0003 * kl_loss)
    ...
    vae.save_weights(filepath="Variational Eagle/Weights/Test/bce_beta_0003.weights.h5", overwrite=True)
    ...
    np.save("Variational Eagle/Extracted Features/Test/bce_beta_0003.npy", extracted_features)
    ...
    np.save("Variational Eagle/Loss/Test/bce_beta_0003.npy", loss)
    ...
    plt.savefig("Variational Eagle/Loss Plots/test_bce_beta_0003")
    plt.show()
    ...
    plt.savefig("Variational Eagle/Reconstructions/Training/test_bce_beta_0003")
    plt.show()
    ...
    plt.savefig("Variational Eagle/Reconstructions/Testing/test_bce_beta_0003")
    plt.show()
