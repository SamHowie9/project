...
for run in [1]:
    ...
    class VAE(keras.Model):
        ...
        def train_step(self, data):
            ...
            with tf.GradientTape() as tape:
                ...
                total_loss = reconstruction_loss + (30 * kl_loss)
    ...
    vae.save_weights(filepath="Variational Eagle/Weights/Test/min_beta_30.weights.h5", overwrite=True)
    ...
    np.save("Variational Eagle/Extracted Features/Test/min_beta_30.npy", extracted_features)
    ...
    np.save("Variational Eagle/Loss/Test/min_beta_30.npy", loss)
    ...
    plt.savefig("Variational Eagle/Loss Plots/test_min_beta_30")
    plt.show()
    ...
    plt.savefig("Variational Eagle/Reconstructions/Training/test_min_beta_30")
    plt.show()
    ...
    plt.savefig("Variational Eagle/Reconstructions/Testing/test_min_beta_30")
    plt.show()
