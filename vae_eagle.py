...
for run in [1]:
    ...
    vae.save_weights(filepath="Variational Eagle/Weights/Test/bce_beta_0004.weights.h5", overwrite=True)
    ...
    np.save("Variational Eagle/Extracted Features/Test/bce_beta_0004.npy", extracted_features)
    ...
    np.save("Variational Eagle/Loss/Test/bce_beta_0004.npy", loss)
    ...
    plt.savefig("Variational Eagle/Loss Plots/test_bce_beta_0004")
    plt.show()
    ...
    plt.savefig("Variational Eagle/Reconstructions/Training/test_bce_beta_0004")
    plt.show()
    ...
    plt.savefig("Variational Eagle/Reconstructions/Testing/test_bce_beta_0004")
    plt.show()
