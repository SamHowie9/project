...
for encoding_dim in [5, 10]:
    ...
    vae.save_weights(filepath="Variational Eagle/Weights/Spirals/bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run) + ".weights.h5", overwrite=True)
    ...
    np.save("Variational Eagle/Extracted Features/Spirals/bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run) + ".npy", extracted_features)
    ...
    np.save("Variational Eagle/Loss/Spirals/bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run) + ".npy", loss)
    ...
    plt.savefig("Variational Eagle/Loss Plots/spirals_bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run))
    plt.show()
    ...
    plt.savefig("Variational Eagle/Reconstructions/Training/Spirals/test_bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run))
    plt.show()
    ...
    plt.savefig("Variational Eagle/Reconstructions/Testing/Spirals/test_bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run))
    plt.show()
