...
for run in [3]:
    ...
    plt.savefig("Variational Eagle/Reconstructions/Testing/fully_balanced" + str(encoding_dim) + "_feature_" + str(epochs) + "_epoch_" + str(batch_size) + "_bs_reconstruction_" + str(run))
    plt.show()
