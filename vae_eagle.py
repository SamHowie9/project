...
for run in [1, 2, 3]:
    ...
    vae.save_weights(filepath="Variational Eagle/Weights/Final/bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run) + ".weights.h5", overwrite=True)
    ...
    np.save("Variational Eagle/Extracted Features/Final/bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run) + ".npy", extracted_features)
    ...
    np.save("Variational Eagle/Loss/Final/bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run) + ".npy", loss)
    ...
    plt.savefig("Variational Eagle/Loss Plots/test_bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run))
    plt.show()
    ...
    plt.savefig("Variational Eagle/Reconstructions/Training/Final/test_bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run))
    plt.show()
    ...
    plt.savefig("Variational Eagle/Reconstructions/Testing/Final/test_bce_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_" + str(run))
    plt.show()
