...
print("High Sersic: ", physical_properties.loc[physical_properties["Cluster"] == 8]["GalaxyID"].tolist())
print("Low Sersic: ",  physical_properties.loc[physical_properties["Cluster"] == 6]["GalaxyID"].tolist())
print("Stripped High Sersic:", physical_properties.loc[physical_properties["Cluster"] == 3]["GalaxyID"].tolist())
print("Stripped Low Sersic:", physical_properties.loc[physical_properties["Cluster"] == 15]["GalaxyID"].tolist())
