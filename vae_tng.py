...
for galaxy in galaxies:
    ...
    hdu_list = fits.open("/cosma7/data/durham/dc-howi1/project/TNG Images/sdss/snapnum_095/data/" + galaxy)
...
# save the weights
vae.save_weights(filepath="Variational TNG/Weights/Original/" + str(encoding_dim) + "_feature_" + str(epochs) + "_epoch_weights_" + str(run) + ".weights.h5", overwrite=True)
...
np.save("Variational TNG/Extracted Features/Original/" + str(encoding_dim) + "_feature_" + str(epochs) + "_epoch_features_" + str(run) + ".npy", extracted_features)
...
np.save("Variational TNG/Loss/Original/" + str(encoding_dim) + "_feature_" + str(epochs) + "_epoch_loss_" + str(run) + ".npy", loss)
...
plt.savefig("Variational TNG/Plots/original_" + str(encoding_dim) + "_feature_loss_" + str(run))
plt.show()
...
plt.savefig("Variational TNG/Reconstructions/Testing/balanced_" + str(encoding_dim) + "_feature_" + str(epochs) + "_epoch_reconstruction_" + str(run))
plt.show()
