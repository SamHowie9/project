...
for run in [1, 2, 3]:
    ...
    np.save("Variational Eagle/Loss/Final/total_loss_" + str(run), total_loss_all)
    np.save("Variational Eagle/Loss/Final/reconstruction_loss_" + str(run), reconstruction_loss_all)
    np.save("Variational Eagle/Loss/Final/kl_loss_" + str(run), kl_loss_all)
