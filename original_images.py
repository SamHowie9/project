...
for i in range(0, 2):
    for j in range(0, 2):
        ...
        print(sersic)
        g1_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_4[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g1_ax.set_xticks([])
        g1_ax.get_yaxis().set_visible(False)
        ...
        g2_ax.imshow(image)
        g2_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_3[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g2_ax.set_xticks([])
        g2_ax.get_yaxis().set_visible(False)
        ...
        g3_ax.imshow(image)
        g3_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_12[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g3_ax.set_xticks([])
        g3_ax.get_yaxis().set_visible(False)
        ...
        g4_ax.imshow(image)
        g4_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_13[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g4_ax.set_xticks([])
        g4_ax.get_yaxis().set_visible(False)
        ...
        g5_ax.imshow(image)
        g5_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_11[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g5_ax.set_xticks([])
        g5_ax.get_yaxis().set_visible(False)
        ...
        g6_ax.imshow(image)
        g6_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_7[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g6_ax.set_xticks([])
        g6_ax.get_yaxis().set_visible(False)
        ...
        g7_ax.imshow(image)
        g7_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_9[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g7_ax.set_xticks([])
        g7_ax.get_yaxis().set_visible(False)
        ...
        g8_ax.imshow(image)
        g8_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_10[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g8_ax.set_xticks([])
        ...
        g9_ax.imshow(image)
        g9_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_5[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g9_ax.set_xticks([])
        ...
        g10_ax.imshow(image)
        g10_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_6[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g10_ax.set_xticks([])
        ...
        g11_ax.imshow(image)
        g11_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_1[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g11_ax.set_xticks([])
        ...
        g12_ax.imshow(image)
        g12_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_8[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g12_ax.set_xticks([])
        ...
        g13_ax.imshow(image)
        g13_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_2[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g13_ax.set_xticks([])
        ...
        g14_ax.imshow(image)
        g14_ax.set_xlabel("$n$ = " + str(np.round(all_properties[all_properties["GalaxyID"] == group_0[count]]["n_r"].tolist()[0], 2)), fontsize=15, labelpad=-20, color="white")
        g14_ax.set_xticks([])
