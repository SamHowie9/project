...
for i in range(0, 2):
    for j in range(0, 2):
        ...
        g3_ax.imshow(image)
        g3_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_12[count]]["n_r"].tolist()[0]), fontsize=20)
        g3_ax.get_xaxis().set_visible(False)
        g3_ax.get_yaxis().set_visible(False)
        ...
        g4_ax.imshow(image)
        g4_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_13[count]]["n_r"].tolist()[0]), fontsize=20)
        g4_ax.get_xaxis().set_visible(False)
        g4_ax.get_yaxis().set_visible(False)
        ...
        g5_ax.imshow(image)
        g5_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_11[count]]["n_r"].tolist()[0]), fontsize=20)
        g5_ax.get_xaxis().set_visible(False)
        g5_ax.get_yaxis().set_visible(False)
        ...
        g6_ax.imshow(image)
        g6_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_7[count]]["n_r"].tolist()[0]), fontsize=20)
        g6_ax.get_xaxis().set_visible(False)
        g6_ax.get_yaxis().set_visible(False)
        ...
        g7_ax.imshow(image)
        g7_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_9[count]]["n_r"].tolist()[0]), fontsize=20)
        g7_ax.get_xaxis().set_visible(False)
        g7_ax.get_yaxis().set_visible(False)
        ...
        g8_ax.imshow(image)
        g8_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_10[count]]["n_r"].tolist()[0]), fontsize=20)
        ...
        g9_ax.imshow(image)
        g9_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_5[count]]["n_r"].tolist()[0]), fontsize=20)
        ...
        g10_ax.imshow(image)
        g10_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_6[count]]["n_r"].tolist()[0]), fontsize=20)
        ...
        g11_ax.imshow(image)
        g11_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_1[count]]["n_r"].tolist()[0]), fontsize=20)
        ...
        g12_ax.imshow(image)
        g12_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_8[count]]["n_r"].tolist()[0]), fontsize=20)
        ...
        g13_ax.imshow(image)
        g13_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_2[count]]["n_r"].tolist()[0]), fontsize=20)
        ...
        g14_ax.imshow(image)
        g14_ax.set_xlabel(str(all_properties[all_properties["GalaxyID"] == group_0[count]]["n_r"].tolist()[0]), fontsize=20)
