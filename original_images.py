...
# create sub figures within main figure, specify their location
gs1 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.025, right=0.225, top=0.975, bottom=0.775)
gs2 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.275, right=0.475, top=0.975, bottom=0.775)
gs3 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.525, right=0.725, top=0.975, bottom=0.775)
gs4 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.775, right=0.975, top=0.975, bottom=0.775)

gs5 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.025, right=0.225, top=0.725, bottom=0.525)
gs6 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.275, right=0.475, top=0.725, bottom=0.525)
gs7 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.525, right=0.725, top=0.725, bottom=0.525)
gs8 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.775, right=0.975, top=0.725, bottom=0.525)

gs9 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.025, right=0.225, top=0.475, bottom=0.275)
gs10 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.275, right=0.475, top=0.475, bottom=0.275)
gs11 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.525, right=0.725, top=0.475, bottom=0.275)
gs12 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.775, right=0.975, top=0.475, bottom=0.275)

gs13 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.025, right=0.225, top=0.225, bottom=0.025)
gs14 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.275, right=0.475, top=0.225, bottom=0.025)
gs15 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.525, right=0.725, top=0.225, bottom=0.025)
gs16 = fig.add_gridspec(nrows=2, ncols=2, wspace=0.3, hspace=0.3, left=0.775, right=0.975, top=0.225, bottom=0.025)
...
ax1.axis("off")
ax1.set_title("Group 4", fontsize=20)

ax2 = fig.add_subplot(gs2[:])
ax2.axis("off")
ax2.set_title("Group 3", fontsize=20)

ax3 = fig.add_subplot(gs3[:])
ax3.axis("off")
ax3.set_title("Group 12", fontsize=20)

ax4 = fig.add_subplot(gs4[:])
ax4.axis("off")
ax4.set_title("Group 13", fontsize=20)

ax5 = fig.add_subplot(gs5[:])
ax5.axis("off")
ax5.set_title("Group 11", fontsize=20)

ax6 = fig.add_subplot(gs6[:])
ax6.axis("off")
ax6.set_title("Group 7", fontsize=20)

ax7 = fig.add_subplot(gs7[:])
ax7.axis("off")
ax7.set_title("Group 9", fontsize=20)

ax8 = fig.add_subplot(gs8[:])
ax8.axis("off")
ax8.set_title("Group 10", fontsize=20)

ax9 = fig.add_subplot(gs9[:])
ax9.axis("off")
ax9.set_title("Group 5", fontsize=20)

ax10 = fig.add_subplot(gs10[:])
ax10.axis("off")
ax10.set_title("Group 6", fontsize=20)

ax11 = fig.add_subplot(gs11[:])
ax11.axis("off")
ax11.set_title("Group 1", fontsize=20)

ax12 = fig.add_subplot(gs12[:])
ax12.axis("off")
ax12.set_title("Group 8", fontsize=20)

ax13 = fig.add_subplot(gs13[:])
ax13.axis("off")
ax13.set_title("Group 2", fontsize=20)

ax14 = fig.add_subplot(gs14[:])
ax14.axis("off")
ax14.set_title("Group 0", fontsize=20)
