...
plt.savefig("Variational Eagle/Correlation Plots/individually_normalised_" + str(encoding_dim) + "_feature_pca_9_all_property_correlation_1_abs", bbox_inches='tight')
plt.show()
