...
#
# axs.scatter(x=extracted_features_switch[1], y=all_properties["n_r"], s=2)
#
...
#
# plt.savefig("Variational Eagle/Plots/pca_feature_1_vs_sersic_" + str(encoding_dim) + "_" + str(run), bbox_inches='tight')
# plt.show()
