...
# 12, 13, 15, 16, 18, 19, 21, 22, 24, 25
        ...
        with tf.device('/CPU:0'):
            ...
            np.save("Variational Eagle/Loss/Transitional/planar_new_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_flows_" + str(n_flows) + "_" + str(run) + "_default_individual_residual.npy", residuals)
