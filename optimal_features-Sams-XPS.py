...
axs[0].errorbar(x=range(10, 51), y=reconstruction_losses.T[1], yerr=[recon_err_lower, recon_err_upper], fmt="o")
...
axs[1].errorbar(x=range(10, 51), y=kl_losses.T[1], yerr=[kl_err_lower, kl_err_upper], fmt="o")
...
axs[2].errorbar(x=range(10, 51), y=num_components.T[1], yerr=[components_err_lower, components_err_upper], fmt="o")
...
plt.savefig("Variational Eagle/Plots/optimal_features_4", bbox_inches="tight")
plt.show()
