...
for run in [run]:
    ...
    # plt.savefig("Variational Eagle/Transition Plots/Ellipticals/pca_latent_" + str(encoding_dim) + "_flows_" + str(n_flows) + "_" + str(run) + "_balanced_inverted", bbox_inches='tight')
