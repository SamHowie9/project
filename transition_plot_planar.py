...
axs[0][0].set_ylabel("dCor < 0.2", fonstsize=60, rotation=0, labelpad=15, va='center', ha="right")
axs[1][0].set_ylabel("Sérsic Index\ndCor = 0.74", fonstsize=60, rotation=0, labelpad=15, va="center", ha="right")
axs[2][0].set_ylabel("Half-Light Radius\ndCor = 0.81", fonstsize=60, rotation=0, labelpad=15, va="center", ha="right")
