...
for run in range(1, 11):
    ...
    z_transformed = np.load("Variational Eagle/Extracted Spirals/Ellipticals/planar_new_latent_" + str(encoding_dim) + "_beta_" + beta_name + "_epoch_" + str(epochs) + "_flows_" + str(n_flows) + "_" + str(run) + "_default_transformed.npy")
