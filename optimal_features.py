...
for i in range(1, 21):
    ...
    features_1 = np.load("Variational Eagle/Extracted Features/Unknown/" + str(i) + "_feature_750_epoch_32_bs_features_1.npy")[0]
    features_2 = np.load("Variational Eagle/Extracted Features/Unknown/" + str(i) + "_feature_750_epoch_32_bs_features_2.npy")[0]
    features_3 = np.load("Variational Eagle/Extracted Features/Unknown/" + str(i) + "_feature_750_epoch_32_bs_features_3.npy")[0]
