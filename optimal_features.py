...
#
#         # load the three different runs
#         loss_1 = list(np.load("Variational Eagle/Loss/Fully Balanced/" + str(i) + "_feature_500_epoch_loss_1.npy"))
#         loss_2 = list(np.load("Variational Eagle/Loss/Fully Balanced/" + str(i) + "_feature_500_epoch_loss_2.npy"))
#         loss_3 = list(np.load("Variational Eagle/Loss/Fully Balanced/" + str(i) + "_feature_500_epoch_loss_3.npy"))
#
#         # sort the reconstruction loss and kl divergence
#         total_sorted = np.sort(np.array([loss_1[0], loss_2[0], loss_3[0]]))
#         reconstruction_sorted = np.sort(np.array([loss_1[1], loss_2[1], loss_3[1]]))
...
# # fig, axs = plt.subplots(2, 1, figsize=(12, 10))
#
# axs.errorbar(df_loss["Extracted Features"], df_loss["Med Total"], yerr=[total_err_lower, total_err_upper], fmt="o", label="500 Epoch, 32 Batch Size")
# axs.set_ylabel("Loss")
# axs.set_xlabel("Extracted Features")
#
#
