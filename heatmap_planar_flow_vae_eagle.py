...
for encoding_dim, n_flows in [[encoding_dim, 1], [encoding_dim, 2], [encoding_dim, 3], [encoding_dim+1, 1], [encoding_dim+1, 2], [encoding_dim+1, 3]]:
    ...
    activations = keract.get_activations(encoder, test_images)

    activation_plot = keract.display_activations(activations, save=True, directory="Variational Eagle/Heatmaps/Activations")

    heatmap_plot = keract.display_heatmaps(activations, input_image=test_images, save=True, directory="Variational Eagle/Heatmaps/Images")