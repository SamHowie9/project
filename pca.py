...
plt.savefig("Variational Eagle/Plots/variance_explained_" + str(encoding_dim) + "_balanced", bbox_inches="tight")
plt.savefig("Variational Eagle/Plots/variance_explained_" + str(encoding_dim) + "_balanced.pdf", bbox_inches="tight")
plt.show()
